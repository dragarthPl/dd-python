...
class AllocationFacade:
    ...
    def find_all_projects_allocations_by(self, project_ids: set[ProjectAllocationsId]) -> ProjectsAllocationsSummary:
        return ProjectsAllocationsSummary.of(self.__project_allocations_repository.find_all_by_id(list(project_ids)))
    ...
    def release_from_project(
        ...
        with self.__session.begin_nested():
            ...
            self.__project_allocations_repository.save(allocations)
            return cast(bool, event.is_present())
    ...
    def __findChosenAllocatableCapability(
        ...
        return next(
            filter(
                ...
                map(
                    lambda allocatable_capability_summary: allocatable_capability_summary.id(),
