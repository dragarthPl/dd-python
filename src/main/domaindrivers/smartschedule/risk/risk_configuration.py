...
from domaindrivers.smartschedule.risk.risk_periodic_check_saga_repository_impl import (
    RiskPeriodicCheckSagaRepositoryImpl,
)
...
class RiskConfiguration(Module):
    def configure(self, binder: injector.Binder) -> None:
        binder.bind(RiskPeriodicCheckSagaRepository, to=RiskPeriodicCheckSagaRepositoryImpl)
