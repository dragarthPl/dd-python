...
class DeviceFacade:
    ...
    def find_all_capabilities(self) -> list[Capability]:
        return cast(list[Capability], self.__device_repository.find_all_capabilities())
    ...
    def schedule_capabilities(self, device_id: DeviceId, one_day: TimeSlot) -> list[AllocatableCapabilityId]:
        return cast(
            ...
            self.__schedule_device_capabilities.setup_device_capabilities(device_id, one_day),
        )
