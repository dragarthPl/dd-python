...
class EmployeeFacade:
    ...
    def find_all_capabilities(self) -> list[Capability]:
        return cast(list[Capability], self.__employee_repository.find_all_capabilities())
    ...
    def schedule_capabilities(self, employee_id: EmployeeId, one_day: TimeSlot) -> list[AllocatableCapabilityId]:
        return cast(
            ...
            self.__schedule_employee_capabilities.setup_employee_capabilities(employee_id, one_day),
        )
