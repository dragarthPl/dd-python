...
if TYPE_CHECKING:
    from src.main.domaindrivers.utils.functional import BiFunction, Function
else:
...
class IntermediateSortedNodesCreator(Generic[T], BiFunction[Nodes[T], SortedNodes[T], SortedNodes[T]]):
    def apply(self, remaining_nodes: Nodes, accumulated_sorted_nodes: SortedNodes[T]) -> SortedNodes[T]:
