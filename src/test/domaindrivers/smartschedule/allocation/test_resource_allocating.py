...
class TestResourceAllocating(TestCase):
    ...
    RESOURCE_ID: Final[AllocatableResourceId] = AllocatableResourceId.new_one()
    ...
    def create_allocatable_resource(
        ...
        capability_selector: CapabilitySelector = CapabilitySelector.can_just_perform(capability)
        return self.schedule_capabilities(resource_id, capability_selector, period)
