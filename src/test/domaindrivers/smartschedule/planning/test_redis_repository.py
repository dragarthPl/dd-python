...
class TestRedisRepository(TestCase):
    test_db_configuration: TestDbConfiguration = TestDbConfiguration(scripts=[])
    ...
    def setUp(self) -> None:
        ...
        self.redis_project_repository = dependency_resolver.resolve_dependency(ProjectRepository)
