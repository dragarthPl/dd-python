...
class TestRiskPeriodicCheckSagaDispatcherE2E(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.risk_saga_dispatcher._RiskPeriodicCheckSagaDispatcher__risk_push_notification = mock()
        self.risk_push_notification = self.risk_saga_dispatcher._RiskPeriodicCheckSagaDispatcher__risk_push_notification
    ...
    def days_before_deadline(self, days: int) -> datetime:
        return cast(datetime, self.PROJECT_DATES.to - timedelta(days=days))
