...
class TestRiskPeriodicCheckSaga(TestCase):
    ...
    def test_updates_initial_demands_on_saga_creation(self) -> None:
        # when
        saga: RiskPeriodicCheckSaga = RiskPeriodicCheckSaga(self.PROJECT_ID, self.SINGLE_DEMAND)
    ...
    def test_informs_about_demands_satisfied_when_demands_rescheduled(self) -> None:
        # given
        saga: RiskPeriodicCheckSaga = RiskPeriodicCheckSaga(self.PROJECT_ID, self.MANY_DEMANDS)
        # and
